 ...
 * @author TOSHIBA
 */
@WebFilter(filterName = "FinancesFilter", urlPatterns = {"/finances/*"})
public class FinancesFilter implements Filter {
    ...
    private static final String SESSION_PROFIL = "finances";
