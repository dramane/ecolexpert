...
@WebFilter(filterName = "activites_debut_semestreFilter", urlPatterns = {"/activites_debut_semestre/*"})
public class Activites_debut_semestreFilter implements Filter {
    ...
    private static final String SESSION_PROFIL = "activites_debut_semestre";
