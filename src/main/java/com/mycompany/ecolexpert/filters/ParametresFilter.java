 ...
 * @author TOSHIBA
 */
@WebFilter(filterName = "ParametresFilter", urlPatterns = {"/parametres/*"})
public class ParametresFilter implements Filter {
    ...
    private static final String SESSION_PROFIL = "parametres";
