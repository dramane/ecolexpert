...
@WebFilter(filterName = "admission_inscriptionFilter", urlPatterns = {"/admission_inscription/*"})
public class Admission_inscriptionFilter implements Filter {
    ...
    private static final String SESSION_PROFIL = "admission_inscription";
