 ...
 * @author TOSHIBA
 */
//@WebFilter(filterName = "EncaissementsFilter", urlPatterns = {"/encaissements/*"})
public class EncaissementsFilter implements Filter {
   private static final String ACCES_PUBLIC   = "/accueil.jsf";
    ...
    private static final String SESSION_PROFIL = "encaissements";
