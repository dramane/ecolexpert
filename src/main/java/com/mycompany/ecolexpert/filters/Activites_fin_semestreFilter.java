...
@WebFilter(filterName = "activites_fin_semestreFilter", urlPatterns = {"/activites_fin_semestre/*"})
public class Activites_fin_semestreFilter implements Filter {
    ...
    private static final String SESSION_PROFIL = "activites_fin_semestre";
