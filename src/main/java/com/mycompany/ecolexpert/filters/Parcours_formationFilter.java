...
@WebFilter(filterName = "parcours_formationFilter", urlPatterns = {"/parcours_formation/*"})
public class Parcours_formationFilter implements Filter {
    ...
    private static final String SESSION_PROFIL = "parcours_formation";
